      ...
      menus: [
        {
          ...
          children: [
            ...
            { path: 'register-user', title: 'Register' }
          ]
        },
        {
          path: 'engineering',
          title: 'Engineering',
          children: [
            { path: 'water-infrastructure', title: 'Water Infrastructure' },
            { path: 'sewer-infrastructure', title: 'Sewer and Stormwater' },
            { path: 'town-planning', title: 'Town Planning' },
            { path: 'development-control', title: 'Development Control' },
            { path: 'survey', title: 'Survey' },
            { path: 'electrical', title: 'Electrical' },
            { path: 'fire-and-ambulance', title: 'Fire and Ambulance' },
            { path: 'waste-management', title: 'Waste Management' },
            { path: 'roads', title: 'Roads' }
          ]
        },
        {
          path: 'finance',
        ...
        },
        {
          ...
          title: 'Housing',
          children: [
            { path: 'reims', title: 'Real Estate' },
            { path: 'demographics', title: 'Demographics' },
            { path: 'cemetries', title: 'Cemeteries' },
            { path: 'parks', title: 'Parks' }         
            ]
        },
        {
          path: 'health',
          title: 'Health',
          children: [
            { path: 'she', title: 'Safety, Health and Environment' },
            { path: 'clinical', title: 'Clinical' }
          ]
        },
        {
          path: 'administration',
          ...
          children: [
            { path: 'engineering-director', title: 'Director of Engineering' },
            { path: 'town-clerk', title: 'Town Clerk' },
            { path: 'mayor', title: 'Mayor' },
            { path: 'asset-management', title: 'Asset Management' },
            { path: 'system-administrator', title: 'System Administrator' }
          ]
        },
        {
          path: 'public',
          title: 'Public',
          children: [
            { path: 'public-housing', title: 'Housing Info' },
            { path: 'public-taxation', title: 'Taxation' },
            { path: 'public-valuation', title: 'Valuation Roll' },
            { path: 'public-amenities', title: 'Amenities' },
            { path: 'public-historic', title: 'Historic Sites' }
          ]
        }
      ]
    }),
